...
const sidebarItems = [
  { name: "Patient Insights", href: "/professional", icon: BarChart3 },
  { name: "Patients", href: "/professional/patients", icon: Users },
  { name: "Session Summaries", href: "/professional/summaries", icon: FileText },
  { name: "Sessions", href: "/professional/sessions", icon: Calendar },
  { name: "Stress Trends", href: "/professional/trends", icon: BarChart3 },
]
